<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true" CodeFile="FinishOrder.aspx.cs" Inherits="FinishOrder" %>
        ...
        <table class="auto-style1"><tr><td></td></tr>
         ...
         <tr><td></td></tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtcu" runat="server" Width="169px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtdel" runat="server" TextMode="MultiLine"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtno" runat="server" TextMode="Number" Width="170px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
