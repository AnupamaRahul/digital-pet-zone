        ...
        <table class="auto-style1"><tr><td></td></tr>
         ...
         <tr><td></td></tr>
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtusern" ErrorMessage="Please enter username!!!" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
